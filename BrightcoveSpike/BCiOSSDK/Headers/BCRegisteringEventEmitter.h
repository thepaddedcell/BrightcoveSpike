...
/**
 * An event emitter used within components. Validates any listeners and event
 * emissions attempted by the component against list of events it is allowed to
 * listen for or emit.
 * 
 ...
 */
- (id)initWithEmitter:(BCEventEmitter *)eventEmitter componentClass:(Class)componentClass;
