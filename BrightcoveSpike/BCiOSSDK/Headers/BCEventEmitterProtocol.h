...
/**
 * **DEPRECATED** Allows an object to add itself as a listener for a type of
 * event by passing in a target object and selector.
 * 
 * @warning Support for this selector/target method of adding listeners will 
 * be removed before this library becomes generally available.
 * 
 * @param type The type of Event to listen for.
 * @param selector The selector to invoke on the target.
 * @param target The target object on which the selector will be invoked.
 */
- (void)on:(NSString *)type callSelector:(SEL)selector onTarget:(id)target;

/**
 * **DEPRECATED** Removes a listener from the list of listeners for the given
 * type. If no previously added listener matches the parameters, calling this
 ...
 * 
 * @param type The type of Event to listen for.
 * @param selector The selector which was previously added.
 * @param target The target object which was previously added.
 */
- (void)off:(NSString *)type callSelector:(SEL)selector onTarget:(id)target;
