 ...
 */
- (id)initWithEventEmitter:(BCEventEmitter *)eventEmitter baseURL:(NSString *)baseURL;
...
/**
 * Callback for @"setAPIKey" event. Initializes api with an api key.
 */
- (void)onSetAPIKey:(BCEvent *)event;
