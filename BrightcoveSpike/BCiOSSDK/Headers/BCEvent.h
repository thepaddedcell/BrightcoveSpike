...
/**
 * Indicates the BCPlayerItem associated with an AVPlayerItem.
 * @param item the BCPlayerItem
 * @param playerItem the AVPlayerItem
 */
extern NSString* const BCEventDidFindItemForPlayerItem;
...
/**
 * Request the BCPlayerItem associated with a AVPlayerItem.
 * @param playerItem the AVPlayerItem to query for.
 */
extern NSString* const BCEventFindItemForPlayerItem;
...
extern NSString* const BCEventSetAPIKey;
