...
typedef enum {
	...
	/** Fill this slot with the first companion ad, but nerver deliver a standalone ad if there is no companion ad */
 ...
 */
FW_EXTERN NSString *FW_NOTIFICATION_VIDEO_DISPLAY_BASE_CHANGED;
 ...
 */
FW_EXTERN NSString *FW_NOTIFICATION_VIDEO_DISPLAY_BASE_FRAME_CHANGED;
